...
impl Composition {
    ...
    ///
    /// ```
    /// # use omnimd_core::sys::Composition;
    ...
    ///
    /// ```
    /// # use omnimd_core::sys::{Composition, ParticleKind};
    ...
    ///
    /// ```
    /// # use omnimd_core::sys::{Composition, Molecule, Particle};
    ...
    ///
    /// ```
    /// # use omnimd_core::sys::{Composition, Particle, Molecule};
    /// let mut composition = Composition::new();
    /// let he = Molecule::new(Particle::new("He")).hash();
    /// let ar = Molecule::new(Particle::new("Ar")).hash();
    ///
