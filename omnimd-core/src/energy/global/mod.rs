...
///
/// ```
/// use omnimd_core::energy::{GlobalPotential, GlobalCache};
/// use omnimd_core::types::{Vector3D, Matrix3};
/// use omnimd_core::sys::{System, Configuration, Particle, Molecule, UnitCell};
///
...
/// use omnimd_core::energy::{GlobalPotential, GlobalCache};
/// use omnimd_core::types::{Vector3D, Matrix3};
/// use omnimd_core::sys::Configuration;
///
/// /// Shift the energy of all the particles by a given delta.
/// #[derive(Clone)]
/// #[allow(dead_code)]
