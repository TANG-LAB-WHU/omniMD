...
use omnimd::{Ewald, GlobalPotential, SharedEwald, Wolf};
...
fn ewald_energy_computation(c: &mut Criterion) {
    ...
    let ewald = get_ewald();
    c.bench_function("nacl::ewald::energy", move |b| {
        b.iter(|| {
    ...
    let system = utils::get_system("nacl");
    let ewald = get_ewald();
    c.bench_function("nacl::ewald::force", move |b| {
        b.iter_batched_ref(
    ...
    let system = utils::get_system("nacl");
    let ewald = get_ewald();
    c.bench_function("nacl::ewald::atomic_virial", move |b| {
        b.iter(|| {
    ...
    let system = utils::get_system("nacl");
    let ewald = get_ewald();
    c.bench_function("nacl::ewald::molecular_virial", move |b| {
        b.iter(|| {
...
fn ewald_monte_carlo_cache(c: &mut Criterion) {
    ...
    c.bench_function("nacl::ewald::move_molecule_cost", move |b| {
        b.iter_batched(
    ...
    c.bench_function("nacl::ewald::move_all_molecules_cost", move |b| {
        b.iter_batched_ref(
...
fn wolf_energy_computation(c: &mut Criterion) {
    let system = utils::get_system("nacl");
    let wolf = get_wolf();
    c.bench_function("nacl::wolf::energy", move |b| {
        b.iter(|| {
    ...
    let system = utils::get_system("nacl");
    let wolf = get_wolf();
    c.bench_function("nacl::wolf::force", move |b| {
        b.iter_batched_ref(
            || vec![Vector3D::zero(); system.size()],
    ...
    let system = utils::get_system("nacl");
    let wolf = get_wolf();
    c.bench_function("nacl::wolf::atomic_virial", move |b| {
        b.iter(|| {
    ...
    let system = utils::get_system("nacl");
    let wolf = get_wolf();
    c.bench_function("nacl::wolf::molecular_virial", move |b| {
        b.iter(|| {
...
fn wolf_monte_carlo_cache(c: &mut Criterion) {
    ...
    c.bench_function("nacl::wolf::move_molecule_cost", move |b| {
        b.iter_batched(
            || utils::move_rigid_molecule(&system),
            |(molid, positions)| cache.move_molecule_cost(&system, molid, &positions),
            BatchSize::SmallInput,
    ...
    c.bench_function("nacl::wolf::move_all_molecules_cost", move |b| {
        b.iter_batched_ref(
            || utils::move_all_rigid_molecule(system.clone()),
            |system| cache.move_all_molecules_cost(system),
            BatchSize::SmallInput,
